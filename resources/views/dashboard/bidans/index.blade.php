                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Auth::user()->level == 'admin')
                                <a href="/dashboard/bidans/create" class="btn btn-primary mb-3 {{ !$cari ? 'd-none' : '' }}"><i class="fas fa-plus-square"></i> Create</a>
                            @endif
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @if (Auth::user()->level == 'admin')
                                    ...
                                    <tbody>
                                        @foreach ($bidan_admin as $bidanItem)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('bidans.edit', $bidanItem->id) }}" class="btn btn-success d-none"><i class="far fa-edit"></i></a>
