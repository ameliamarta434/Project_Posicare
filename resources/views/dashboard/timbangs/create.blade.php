...
@section('container')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Timbang Anak</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                        <li class="breadcrumb-item active">Tambah Timbang Anak</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Timbang Anak</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="/dashboard/timbang_anak" class="mb-5" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="container">
                                    <div class="row">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control @error('anak_id') is-invalid @enderror" name="anak_id">
                                                    ...
                                                    @foreach ($anaks as $row)
                                                        <option value="{{ $row->id }}" {{ old('anak_id') == $row->id ? ' selected' : ' ' }}>{{ $row->nama_anak }}</option>
                                                    @endforeach
                                                </select>
                                                @error('ortu_id')
